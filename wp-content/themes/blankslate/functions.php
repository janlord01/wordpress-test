...
// AJAX handler to load products based on filter options
...
function enqueue_product_catalog_script() {
    wp_enqueue_script('product-catalog-script', get_template_directory_uri() . '/product-catalog.js', array('jquery'), '1.0', true);
}
